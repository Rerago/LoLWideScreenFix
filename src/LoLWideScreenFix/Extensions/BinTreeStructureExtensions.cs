...
namespace LoLWideScreenFix.Extensions
{
    ...
    internal static class BinTreeStructureExtensions
    {
        ...
        /// <param name="obj">The <seealso cref="BinTreeObject"/> from which the property is to be determined.</param>
        /// <param name="hashName">Hash of the name of the property</param>
        /// <returns>The property of type <seealso cref="T"/>.</returns>
        internal static T GetPropertyByTyp<T>(this BinTreeStructure obj, uint hashName) where T : BinTreeProperty
